...
console.log(paymentStatus)
  ...
  if (item.data) {
    ...
    return (
      <tr key={item.id}>
        <td className=" pl-3 py-4 border-y-[1px] border-l-[1px] rounded-bl-xl rounded-tl-xl border-slate-300 ">
          <span className="font-semibold">{item.salesman.name}</span>
          <br />
          <span className="text-gray-400 text-sm">{item.business.name}</span>
        </td>
        <td className="border-y-[1px]  border-slate-300 ">{item.payment_value}</td>
        <td className="border-y-[1px]  border-slate-300 ">
        ...
        <td className="border-y-[1px]  border-slate-300 ">
          <div className="flex gap-2 items-center">
            <div className={`w-3 h-3 ${item.status_payment ? "bg-green-600": "bg-yellow-600"} rounded-full `} />
        ...
        <td className="border-y-[1px]  border-slate-300 border-r-[1px] rounded-br-xl rounded-tr-xl">

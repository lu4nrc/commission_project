    ...
    <Draggable key={item.id} draggableId={item.id} index={index}>
      {(provided, snapshot) => (
        <div
          ...
          className={`shadow-md border border-gray-50 bg-white relative flex flex-col gap-1 select-none pt-6 mb-2 min-h-[150px] overflow-hidden rounded-md  ${
        ...
        >
          ...
          <div className="flex flex-col gap-1 p-2">
            ...
            <p className="font-medium text-xs">{item.contact.name}</p>

...
const UpdateBusinessForm = ({ toggle, business, updateBusinessData }) => {
      ...
      <div className="flex gap-3">
        ...
        <div className="w-1/2">
          <span>
            ...
            recusandae eos alias, minima voluptate reiciendis quisquam sed
            veritatis suscipit id facilis, voluptates enim nisi, magnam qui
            officiis est laborum odio placeat perspiciatis. Perferendis,
            blanditiis iure.
          </span>
        </div>
      </div>
